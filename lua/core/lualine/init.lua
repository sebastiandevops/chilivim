...
lualine.setup({
    ...
    globalstatuses = true,
		icons_enabled = true,
		theme = colors.theme, -- Choose between "auto", "auto_theme_custom" for transparent components or use colors.theme and customize your colors under colors.lua file.
